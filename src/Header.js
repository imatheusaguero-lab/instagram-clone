...
export default function Header(props){
    ...
    function uploadPost(e){
        ...
        const uploadTask = storage.ref(storage, `images/${file.name}`).put(file);
        ...
        ,function() {
            storage.ref("images").child(file.name).getDowloadUrl()
            .then(function(url){
            ...
            <div className="modalCriarConta">
                <div className="formCriarConta">
                    ...
                    <form onSubmit={(e)=>criarConta(e)}>
                        ...
                        <input id="username-cadastro"type="text" placeholder="Seu nome..."></input>
        ...
        //VERDADEIRO
            ...
            ://FALSO
                <div onSubmit={(e)=>logar(e)} className='header__loginForm'>
                    ...
                    <a onClick={(e)=>abrirModalCriarConta(e)} href='#'>Criar Contra!</a>
                    </div>
                </div>
            } {/*FIM OPERADOR CONDICIONAL*/}
        </div> {/*FIM CLASSNAME CENTER */}
    </div>//FIM CLASSNAME HEADER
    )
}
